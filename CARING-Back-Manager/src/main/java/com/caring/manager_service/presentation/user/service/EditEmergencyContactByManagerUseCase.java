...
public class EditEmergencyContactByManagerUseCase {
    ...
    public void execute(String managerCode,
                        ...
                        String userUuid,
                        String contactUuid,
                        RequestEmergencyContactWithContactUuid request) {
        validateAuthOfHandleUser(
                managerValidator.isGroupedUser(managerCode, userUuid),
                CREATE_OR_DELETE_SENIOR_ACCOUNT,
                roles
        );
        userServiceClient.updateEmergencyContact(contactUuid, request);
    }
}
