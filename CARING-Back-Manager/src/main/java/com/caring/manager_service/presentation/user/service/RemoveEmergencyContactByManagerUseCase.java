...
public class RemoveEmergencyContactByManagerUseCase {

    private final ManagerValidator managerValidator;
    private final UserServiceClient userServiceClient;

    public void execute(String managerCode, List<String> roles, String userUuid, String contactUuid) {
        ...
        userServiceClient.deleteEmergencyContact(contactUuid);
    }
}
