...
import com.caring.manager_service.infra.user.vo.request.RequestAddress;
...
public class EditUserAddressByManagerUseCase {
    ...
    public void execute(String managerCode,
        ...
        userServiceClient.updateUserAddress(userUuid, requestAddress);
